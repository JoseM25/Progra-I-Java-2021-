...
public class Controlador
{
    ...
    public Controlador() 
    {
        ...
        while ((valorSaldo==null)||(valorSaldo.equals(""))){
            interfaz.showMessageDialog(null,"Entrada Invalida. Vuelva a intentarlo");
            valorSaldo=interfaz.showInputDialog(null,"¿Con cuál monto desea abrir la cuenta 1?");
        }
        double saldoInicial;
    ...
    public void iniciar()
    {
        ...
        do {
            ...
            switch (opcion) {
                ...
                default:
                    interfaz.showMessageDialog(null, "Opción inválida, vuelva a escoger.");
            }
        }while(!opcion.equals("5"));
    }

    /**
     * Método alternativo que despliega un menú y permite al usuario escoger y 
     * ejecutar la opción de su preferencia. 
     */
    ...
    private void realizarConsulta()
    {
        ...
        while ((laCuenta==null)||(laCuenta.equals(""))){
            interfaz.showMessageDialog(null,"Entrada Invalida. Vuelva a intentarlo");
            laCuenta=interfaz.showInputDialog(null,"Digite el monto a depositar:");
        }
        double saldoActual;
    ...
    {
        String valorMonto = interfaz.showInputDialog(null,"Digite el monto a retirar:");
        while ((valorMonto==null)||(valorMonto.equals(""))){
            interfaz.showMessageDialog(null,"Entrada Invalida. Vuelva a intentarlo");
            valorMonto=interfaz.showInputDialog(null,"Digite el monto a retirar:");
        }
        double monto = Double.parseDouble(valorMonto);
        String laCuenta = interfaz.showInputDialog(null,"¿De cuál cuenta desea realizar el retiro,\nde la 1 ó de la 2?");
    ...
    {
        String mensaje;
        mensaje = "Programadora: Maureen Murillo R.\nProfesora ECCI\n2021";
        interfaz.showMessageDialog(null, mensaje);
    }
    ...
    /**
     * Método que permite iniciar el programa d= nel cajero bancario.
     */
    public static void main(String[] parametros) {
        Controlador miControlador = new Controlador();
        miControlador.iniciar2();
    }
}
