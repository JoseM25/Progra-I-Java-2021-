...
public class Controlador{
    ...
    private final String[] OPCIONES = {"Salir", "Verificar vacia", "Encolar","Desencolar", "Contar", "Eliminar","Buscar","Imprimir"}; 
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 2: 
                    ...
                    lista.encolar(unElemento);
                    break;

                case 3:     
                    boolean confirmadorDes=lista.desEncolar();
                    String respuesta=Boolean.toString(confirmadorDes);
                    interfaz.decirMensaje(respuesta);
                    break;
