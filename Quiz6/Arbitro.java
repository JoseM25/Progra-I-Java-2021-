...
public class Arbitro
{
    ...
    private final String[] OPCIONES = {"Salir", "Mostrar Tablero", "Mezclar Tablero", "Terminar Partida"}; 

    public Arbitro(String laPalabra, Interfaz laInterfaz, Tablero elTablero)
    {
